    ...
    public partial class Form4 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e) //คำสั่งที่เลือกรุ่นในcombobox
        {
            if (comboBox1.Text == "รุ่นDC70")
            {
                ...
                cmd = conn.CreateCommand();
                cmd.CommandText = "SELECT รหัสสินค้า, name, รุ่น_DC,ราคา,x FROM stock_70 "; 
            ...
            else if(comboBox1.Text == "รุ่นDC95")
            {
                ...
                cmd = conn.CreateCommand();
                cmd.CommandText = "SELECT รหัสสินค้า,name,รุ่น_DC,ราคา,x FROM stock_95 ";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e) //โค้ดสลิป
        {
            ...
            e.Graphics.DrawString("รวมทั้งสิ้น" + totaltext.Text + "\tบาท", new Font("TH SarabunPSK", 18, FontStyle.Regular), Brushes.Black, new Point(570, (y + 50) + 30));
            ...
            e.Graphics.DrawString("ร้านWonderland ขายอะไหล่รถเกี่ยว", new Font("TH SarabunPSK", 18, FontStyle.Regular), Brushes.Black, new Point(290, ((((y + 30) + 45) + 45) + 45) + 60));
            e.Graphics.DrawString("       ขอบคุณที่ใช้บริการ      ", new Font("TH SarabunPSK", 18, FontStyle.Regular), Brushes.Black, new Point(290, (((((y + 30) + 45) + 45) + 45) + 45) + 60));
        ...
        private void loaddata()
        {
            ...
            conn.Open();
                ...
                while (adapter.Read())
                {
                    Program.id = adapter.GetString("รหัสสินค้า");
